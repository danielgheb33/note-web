...
function PrivacyPolicy() {
    ...
    return (
        <ResourcePage title={"Privacy Policy"} body={"CS32 Notes PRIVACY POLICY\n" +
        "\n" +
        "CS32 Notes(the “Company”) is committed to maintaining robust privacy protections for its users.  Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.  \n" +
        "\n" +
        "For purposes of this Agreement, “Site” refers to the Company’s website, which can be accessed at localhost:3000.\n" +
        "“Service” refers to the Company’s services accessed via the Site, in which users can . \n" +
        "The terms “we,” “us,” and “our” refer to the Company.\n" +
        "“You” refers to you, as a user of our Site or our Service. \n" +
        "By accessing our Site or our Service, you accept our Privacy Policy and Terms of Use (found here: https://docs.google.com/document/d/1joIAIP5SbpduO_4GYxriKhVsD-9AVUEqxs6g7T23QM4/edit?usp=sharing ), and you consent to our collection, storage, use and disclosure of your Personal Information as described in this Privacy Policy.\n" +
        "\n" +
        "I. INFORMATION WE COLLECT\n" +
        "\n" +
        "We collect “Non-Personal Information” and “Personal Information.” Non-Personal Information includes information that cannot be used to personally identify you, such as anonymous usage data, general demographic information we may collect, referring/exit pages and URLs, platform types, preferences you submit and preferences that are generated based on the data you submit and number of clicks. Personal Information includes your email and password which is connected to your gmail account, which you submit to us through the registration process at the Site. After the registration we will also have any other personal information inside of your notes stored within our database. \n" +
        "\n" +
        ...
        "VI. CONTACT US\n" +
        "\n" +
        "If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us by sending an email to tashawn_arabian@brown.edu .\n" +
        "Last Updated: This Privacy Policy was last updated on 4/16/21.\n"}/>
    );
}
