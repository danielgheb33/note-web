...
function TermsAndConditions() {
    ...
    return (
        <ResourcePage title={"Terms & Conditions"} body={"CS32 NotesTerms of Use\n" +
        "4/16/21\n" +
        " \n" +
        "Welcome to the CS32 Note’s Terms of Use agreement. For purposes of this agreement, “Site” refers to the Company’s website, which can be accessed at localhost:3000. “Service” refers to the Company’s services accessed via the Site, in which users can use our application to create and use notes. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our Site or our Service. \n" +
        "\n" +
        "The following Terms of Use apply when you view or use the Service via our website located at localhost:3000\n" +
        "\n" +
        ...
        "PRIVACY POLICY\n" +
        "\n" +
        "The Company respects the privacy of its Service users. Please refer to the Company’s Privacy Policy (found here:https://docs.google.com/document/d/1OjhDhqeI9xDY6JhWCkfTWxKrbPk-PMSBZEDb3-2FaDg/edit?usp=sharing ) which explains how we collect, use, and disclose information that pertains to your privacy. When you access or use the Service, you signify your agreement to the Privacy Policy as well as these Terms of Use.\n" +
        "\n" +
        "ABOUT THE SERVICE\n" +
        "\n" +
        "The Service allows you to create an account with google, this account allows you to create files and notes in any way you desire. The user could implement tags and links, which come together to create a webview for the user. Allowing an aesthetically pleasing visual of the user’s notes. All of these notes and files will be saved to our database via the user’s email. \n" +
        "\n" +
        "REGISTRATION; RULES FOR USER CONDUCT AND USE OF THE SERVICE\n" +
        "\n" +
        "You need to be at least 13 years old and a resident of the United States to register for and use the Service. If you are a user who signs up for the Service, you will create a personalized account which includes a unique username and a password to access the Service and to receive messages from the Company. You agree to notify us immediately of any unauthorized use of your password and/or account. The Company will not be responsible for any liabilities, losses, or damages arising out of the unauthorized use of your member name, password and/or account.\n" +
        "\n" +
        "\n" +
        "USE RESTRICTIONS\n" +
        ...
        "\n" +
        "When you create your own personalized account, you may be able to provide your own google account, which contains both the email and password, (“User Content”) to the Service. You are solely responsible for the User Content that you post, upload, link to or otherwise make available via the Service. \n" +
        ...
        "(b) DMCA Take-Down Notices.  If you are a copyright owner or an agent thereof and believe, in good faith, that any materials provided on the Service infringe upon your copyrights, you may submit a notification pursuant to the Digital Millennium Copyright Act (see 17 U.S.C 512) (“DMCA”) by sending the following information in writing to the our designated copyright agent at 69 Brown Street:\n" +
        " \n" +
        ...
        "4.   Your name, address, telephone number, and email address, a statement that you consent to the jurisdiction of the federal court in Rhode Island and a statement that you will accept service of process from the person who provided notification of the alleged infringement.\n" +
        ...
        "\n" +
        "We may also use your email address to send you other messages, including information about the Site or the Service and special offers. You may opt out of such email by changing your account settings, using the “Unsubscribe” link in the message, or by sending an email to tashawn_arabian@brown.edu or mail to the following postal address:\n" +
        "Customer Support\n" +
        "69 Brown Street\n" +
        ...
        "\n" +
        "These Terms of Use and your use of the Site are governed by the federal laws of the United States of America and the laws of the State of Rhode Island, without regard to conflict of law provisions.\n" +
        "\n" +
        "We may assign or delegate these Terms of Service and/or our Privacy Policy, in whole or in part, to any person or entity at any time with or without your consent. You may not assign or delegate any rights or obligations under the Terms of Service or Privacy Policy without our prior written consent, and any unauthorized assignment or delegation by you is void.\n" +
        "\n" +
        "YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF USE, UNDERSTAND THE TERMS OF USE, AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE TERMS OF USE TOGETHER WITH THE PRIVACY POLICY AT https://docs.google.com/document/d/1OjhDhqeI9xDY6JhWCkfTWxKrbPk-PMSBZEDb3-2FaDg/edit?usp=sharing REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT SUPERSEDES ANY PROPOSAL OR PRIOR AGREEMENT ORAL OR WRITTEN, AND ANY OTHER COMMUNICATIONS BETWEEN US RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT."}/>
    );
}
